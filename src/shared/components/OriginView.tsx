  ...
  return (
    <div className="relative" style={{ width, height }}>
      ...
      <div
        ...
        className="bg-[#f6f8facb] absolute top-2 right-6 z-10 flex items-center gap-2 rounded-[12px] font-bold shadow-md hover:bg-[#eaeef2] text-[#404040] px-3 py-1 text-sm cursor-pointer"
      >
        <div>링크 열기</div>
