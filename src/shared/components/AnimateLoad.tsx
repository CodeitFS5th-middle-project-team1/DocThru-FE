...
const AnimateLoad: React.FC = () => {
  return (
    <div className="absolute inset-0 w-full h-full flex flex-col justify-center items-center bg-[#E9E8E3] z-[99] animate-[offscreen_0.5s_1.0s_forwards]">
      <div className="w-[270px] h-[270px]">
        ...
        >
          <g>
            {/* 얼굴 */}
            <g className="opacity-0 animate-[popup_1.5s_0s_cubic-bezier(0.95,0.05,0.795,0.035)_forwards]">
              <path
                fill="#58585A"
            ...
            <g className="opacity-0 animate-[popup_1.5s_0s_cubic-bezier(0.95,0.05,0.795,0.035)_forwards]">
              ...
              />
              <circle
                className="animate-[follow_1.5s_0s_forwards]"
                fill="#58585A"
                cx="66.063"
                cy="127.511"
                r="8.949"
            ...
            <g className="opacity-0 animate-[popup_1.5s_0s_cubic-bezier(0.95,0.05,0.795,0.035)_forwards]">
              <polyline
                className="animate-[patient_1s_0s_ease-in_forwards]"
                fill="none"
                stroke="#58585A"
                strokeWidth="4"
                strokeLinecap="round"
              ...
              />
              <path
                className="opacity-0 animate-[happy_0.6s_0.9s_ease-in_forwards]"
                fill="none"
                stroke="#58585A"
                strokeWidth="4"
                strokeLinecap="round"
      ...
      <div className="relative mt-16 w-[250px] bg-[#C1C0BC] h-[4px] rounded">
        <div className="absolute top-0 left-0 h-full bg-[#58585A] rounded animate-[load_1.5s_0s_forwards]" />
      </div>
